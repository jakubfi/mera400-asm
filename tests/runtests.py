...
class TestBed:
    ...
    def __assembly(self, source):
        ...
        args = [self.emas, "-DEM400", "-I../", "-Oraw", "-o" + aout, source]
...
parser.add_argument("-e", "--emulator", help="emulator binary to run", default="/home/amo/projekty/mera400/em400/build/em400")
